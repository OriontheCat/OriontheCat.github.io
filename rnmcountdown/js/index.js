...
function updateTitle() {
      if (d < new Date(ep2)) {window.deadline = ep2
      document.getElementById("rnmep").innerHTML = "Rick and Morty S3E2";
    } else if (new Date(ep2) < d && d < new Date(ep3)) {window.deadline = ep3
      document.getElementById("rnmep").innerHTML = "Rick and Morty S3E3";
    } else if (new Date(ep3) < d && d < new Date(ep4)) {window.deadline = ep4
      document.getElementById("rnmep").innerHTML = "Rick and Morty S3E4";
    } else if (new Date(ep4) < d && d < new Date(ep5)) {window.deadline = ep5
      document.getElementById("rnmep").innerHTML = "Rick and Morty S3E5";
    } else if (new Date(ep5) < d && d < new Date(ep6)) {window.deadline = ep6
      document.getElementById("rnmep").innerHTML = "Rick and Morty S3E6";
    } else if (new Date(ep6) < d && d < new Date(ep7)) {window.deadline = ep7
      document.getElementById("rnmep").innerHTML = "Rick and Morty S3E7";
    } else if (new Date(ep7) < d && d < new Date(ep8)) {window.deadline = ep8
      document.getElementById("rnmep").innerHTML = "Rick and Morty S3E8";
    } else if (new Date(ep8) < d && d < new Date(ep9)) {window.deadline = ep9
      document.getElementById("rnmep").innerHTML = "Rick and Morty S3E9";
    } else if (new Date(ep9) < d && d < new Date(ep10)) {window.deadline = ep10
